...
.PHONY: build
build: clean stop_adore_cli build_vendor_libraries build_adore_cli_core build_adore_cli build_user_libraries build_ros_nodes build_services ## Build and setup adore cli
